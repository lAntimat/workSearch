...
public class Vacancy {
    ...
    public Vacancy(String id, String name, String salary, Date date, String companyName, String city, String experiency, String workType, String fullText, String numberForCall) {
        this.id = id;
        this.name = name;
        this.salary = salary;
        this.date = date;
